...
<head>
    ...
    <title> Users | <?php require_once __DIR__ . '/../../../helpers/title.php'; ?> </title>
    ...
    <div class="modal fade" id="createUserModal" tabindex="-1" aria-labelledby="createUserModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../../../app/controllers/admin/UsersController.php" method="POST">
                ...
                <tbody>
                    <?php foreach($users as $user): ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#editUserModal" onclick="editUser(<?= htmlspecialchars(json_encode($user)) ?>)">Edit</button>
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteUserModal" onclick="setDeleteUserId(<?= $user['id'] ?>)">Delete</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
