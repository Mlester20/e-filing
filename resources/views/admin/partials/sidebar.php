    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      <div class="app-brand demo">
        <a href="dashboard.php" class="app-brand-link">
          ...
          <span class="app-brand-text demo menu-text fw-semibold ms-2">E-Filing</span>
        </a>
      ...
      <ul class="menu-inner py-1">
        ...
        <!-- Pages -->
        <li class="menu-header mt-7"><span class="menu-header-text">Records</span></li>

        <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon icon-base ri ri-layout-left-line"></i>
            <div data-i18n="Room Types">Student Records</div>
          </a>
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="student-records.php" class="menu-link">
                <div data-i18n="Student Records">Student Records</div>
              </a>
            </li>
          </ul>
        </li>
